...
| TempMail | [tempmail4gi5qfqzjs2bxo3wf6eurplxmior6ohz5vw7aeay67wiyd.onion](http://tempmail4gi5qfqzjs2bxo3wf6eurpelxmior6ohzq5vw7aeay67wiyd.onion) |
...
| --- | --- |
| Tor status | [t3qi4hdmvqo752lhyglhyb5ysoutggsdocmkxhuojfn62ntpcyydwmqd.onion](http://t3qi4hdmvqo752lhglhyb5ysoutgsdocmkxhuojfn62ntpcyydwmqd.onion) |
...
- Exit Node — The data finally exits the Tor network through an exit node. The exi node is thelast point of decryption in the circuit and connects to the destination server on behalf of the user. The exit node knows the destination of the data but doesn't know the original source.
